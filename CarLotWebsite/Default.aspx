<%@ Page Title="" Language="C#" MasterPageFile="~/CarBook.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <br />
            <asp:ListBox ID="lstCar" runat="server" style="z-index: 1; height: 197px; width: 327px" OnSelectedIndexChanged="lstCar_SelectedIndexChanged"></asp:ListBox>
                        <br />
            <asp:Label ID="lblError" runat="server" style="z-index: 1; width: 393px"></asp:Label>

            <br />
            <br />
            <asp:Label ID="lblCarMake" runat="server" style="z-index: 1; width: 317px" Text="Please Enter a Car No"></asp:Label>
            <br />
            <asp:TextBox ID="txtCarMake" runat="server" style="z-index: 1; width: 169px"></asp:TextBox>
            <br />
            <br />
