...
<body>
    ...
    <div class="row">
        <div class="column">
            <div class="card">
                <img src="Images/addem.jpg"  style="width:90%">
                <div class="container">
                    <h2>Add New Employee</h2>
                    <p>Click Below to add new Employee onto the system </p>
                    <p> <button href="EmployeePortal/AddEmployee.html">go</button>  </p>
</div>
            </div>
        </div>
        ...
        <div class="column">
            <div class="card">
                <img src="Images/searchem.jpg" style="width:90%">
                <div class="container">
        ...
        <div class="column">
            <div class="card">
                <img src="Images/pem.png"  style="width:90%">
                <div class="container">
        ...
        <div class="column">
            <div class="card">
                <img src="Images/report1.jpg"  style="width:90%">
                <div class="container">
                    <h2>Reports </h2>
                    <p><button class="button">go</button></p>
                </div>
